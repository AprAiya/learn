...
<html lang="zh-CN">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8">      
        <form action="/flower/do_modify">
            <input type="hidden" id="id" name="id" value="${flower.id}">
            <div class="form-group">
                <label for="name">花名</label>
                <input type="text" class="form-control" id="name" name="name" value="${flower.name}" placeholder="请输入花名">
            </div>
            <div class="form-group">
                <label for="yanse">花名</label>
                <input type="yanse" class="form-control" id="yanse" name="yanse" value="${flower.yanse}" placeholder="请输入颜色">
            </div>
